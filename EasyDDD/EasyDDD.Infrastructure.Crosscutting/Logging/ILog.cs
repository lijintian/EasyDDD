...
namespace EasyDDD.Infrastructure.Crosscutting.Logging
{
    ...
    public interface ILog
    {
        ...
        void Debug(Type type, string message, Exception exception,
            string memberName = "",
            string sourceFilePath = "",
            int sourceLineNumber = 0);
        ...
        void Debug(Type type, object item,
            string memberName = "",
            string sourceFilePath = "",
            int sourceLineNumber = 0);
        ...
        void Fatal(Type type, string message, Exception exception,
            string memberName = "",
            string sourceFilePath = "",
             int sourceLineNumber = 0);
        ...
        /// <param name="args">The arguments values</param>
        void LogError(Type type, string message,
            string memberName = "",
            string sourceFilePath = "",
             int sourceLineNumber = 0);
        ...
        /// <param name="args">The arguments values</param>
        void LogError(Type type, string message, Exception exception,
            string memberName = "",
            string sourceFilePath = "",
             int sourceLineNumber = 0);
    }
